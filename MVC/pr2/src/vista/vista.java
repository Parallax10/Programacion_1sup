...
// 📚 Panel Libros
        ...
        JPanel libroButtons = new JPanel();
        libroButtons.add(btnAgregarLibro);
        libroButtons.add(btnEliminarLibro);
        panelLibros.add(libroButtons, BorderLayout.SOUTH);
        ...
        btnAgregarLibro.addActionListener(e -> {
            ...
            if (titulo != null && autor != null && isbn != null) {//para agregar libros
                libroController.agregarLibro(new Libro(titulo, autor, isbn));
        ...
        btnEliminarLibro.addActionListener(e -> {
            ...
            if (fila != -1) {
                int idLibro = (int) tablaLibros.getValueAt(fila, 0);//para eliminarlos
        ...
        btnAgregarUsuario.addActionListener(e -> {
            ...
            if (nombre != null && email != null) {
                ...
                actualizarTablaUsuarios();//agregar usuarios
            }
        });
        btnEliminarUsuario.addActionListener(e -> {
            int fila = tablaUsuarios.getSelectedRow();
            if (fila != -1) {//eliminar usuarios
        ...
        btnPrestarLibro.addActionListener(e -> {
            ...
            if (idLibroStr != null && idUsuarioStr != null) {
                int idLibro = Integer.parseInt(idLibroStr);//prestar libros
